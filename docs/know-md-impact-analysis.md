...
|---|---|---|---|---|---|
| `adding-projects-resource.md` | Knowledge (focused prompt) | 10s | ~120 | ✅ CRUD + router | ❌ Patterns only |
| `session-report.md` | Code-only (no KNOW.md) | 57s | ~350 | ❌ None | ✅ Full 260-file inventory |
